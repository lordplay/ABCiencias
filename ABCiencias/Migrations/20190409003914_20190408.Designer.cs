...
namespace ABCiencias.Migrations
{
    ...
    [Migration("20190409003914_20190408")]
    partial class _20190408
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ABCiencias.Models.Servicos.Log.LogRequest", b =>
                {
                    b.Property<int>("IdLogRequest")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
                    ...
                    b.Property<int?>("UrlShortener_fk");

                    b.Property<string>("UserHostAddress");

                    b.HasKey("IdLogRequest");

                    b.HasIndex("UrlShortener_fk");
            ...
            modelBuilder.Entity("ABCiencias.Models.Servicos.Log.LogRequest", b =>
                {
                    b.HasOne("ABCiencias.Models.URLShortener", "uRLShortener")
                        .WithMany()
                        .HasForeignKey("UrlShortener_fk");
                });
